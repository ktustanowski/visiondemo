...
- [Detecting body pose using Vision framework]([https://cornerbit.tech/detecting-body-pose-using-vision-framework/](https://medium.com/@kamil.tustanowski/detecting-body-pose-using-vision-framework-caba5435796a)) using application version [0.1.0](https://github.com/ktustanowski/visiondemo/releases/tag/v0.1.0)
...
- [Detecting body pose, hand pose, and face landmarks using Vision framework]([https://cornerbit.tech/detecting-body-pose-hand-pose-and-face-landmarks-using-vision-framework/](https://medium.com/@kamil.tustanowski/detecting-body-pose-hand-pose-and-face-landmarks-using-vision-framework-645dc62c4b93)) using application version [0.2.0](https://github.com/ktustanowski/visiondemo/releases/tag/v0.2.0)
